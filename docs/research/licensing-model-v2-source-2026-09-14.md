> **Archived research proposal, received 14 September 2026.** The owner has since
> selected retained contributor copyright and company licensing. Read the
> [maintainer assessment](licensing-model-v2-assessment-2026-09-14.md) and
> [selected design](../licensing-model-v2.md) for the implemented decision.
> No agreement or commercial licence is activated by this archive. The body is
> retained with only four package-relative links converted to labelled references.
> Mail headers, sender details and raw mail are not published. The implementation
> package is retained privately; its apply script was not run.

# DAIA rights model v2: retained copyright, entity-neutral licensing

**Design for review, not an operative agreement. No licence programme, contributor
assent, legal entity or commercial clearance is activated by this change.**
This is the current proposal, superseding mandatory foundation ownership in the
earlier decision (supplied package: `core-rights-decision-2026-09-13.md`). `LICENSE` is unchanged.
...
interim analysis (supplied package: `interim-rights-custody-proposal.md`).

## Minimum acceptance state and implementation status

The grant architecture (supplied package: `contributor-commercial-grant.md`) and
private register/acceptance workflow (supplied package: `licensing-rights-register.md`) specify the
