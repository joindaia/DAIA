...
and independent contributor capacity is available. Workers receive their assignment
...
| 3 | Complete the review cycle: inspect persistent exposure and assignment selection after release and across later campaigns | An independent eligible root reviews a new candidate; same-root keys and previously exposed reviewers remain excluded. A real scheduled producer/reviewer cycle, human triage and manual merge are still needed. |
